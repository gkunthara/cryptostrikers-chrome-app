  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <img style={{width: "85%", height: "auto", textAlign: "center"}} src={this.state.card.image} alt="image" />
        <h3 style={alignCenter}>{this.state.card.sale}</h3>
        <h3 style={alignCenter}>{this.state.card.sale_time}</h3>
      </div>
    );
  }
}
