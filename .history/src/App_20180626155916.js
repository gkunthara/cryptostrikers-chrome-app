  ...
  render() {
    ...
    return (
      <div className="App center">
        <button onClick={this.decrement}>{"<-"}</button><h4 className="light">Last Sold Card <button className="button-style" onClick={this.increment}><img src={arrowRight} alt="arrow_right"/></button></h4>
