  ...
  render() {
    ...
    return (
      <div className="App center">
        <button className="button-style" onClick={this.decrement}><img className="arrows" src={arrowLeft} alt="arrow_left"/></button><h4 className="light">Last Sold Card <button className="button-style" onClick={this.increment}><img className="arrows" src={arrowRight} alt="arrow_right"/></button></h4>
