...
class App extends Component {
  ...
  componentDidMount() {
    ...
    changeCard(){
          const lastSoldCard = this.state.assets[this.state.clickCount] 
  ...
  render() {
    ...
    return (
      <div className="App center">
        <button onClick={this.handleClickDec.bind(this)}>{"-"}</button><h4 className="light">Last Sold Card <button onClick={this.handleClickInc.bind(this)}>{"+"}</button></h4>
